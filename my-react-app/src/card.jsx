    ...
    <div className="p-4 bg-gray-900 text-white mt-3 overflow-hidden">
      ...
      {data && (
        <div className="bg-[#1D2532] rounded-2xl outline outline-2 outline-gray-600 overflow-hidden font-semibold">
            ...
            <div> 
                <h1 className="text-lg ml-2 mt-2">{data.title || data.name}</h1>
                <h1 className="text-sm ml-2 text-gray-400">#{data.id}</h1>
            </div>
            <div className="flex pb-3">
                <div className="ml-2 mt-4 bg-[#0080FF] rounded-3xl px-1 flex items-center"> 
                ...
                <div className="items-center flex ml-3 mt-4 bg-[#304D68] rounded-full p-2 h-full"> 
