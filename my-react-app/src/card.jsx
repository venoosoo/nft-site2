        ...
        <div className="flex pb-3 items-center justify-center">
          <div className={` ${
            ...
            <button
                ...
                >
                {collection.text ? collection.text : Math.round(data.price * 10) / 10}
            </button>
            {!isNaN(Number(data.price)) && (!collection.text) && ( <svg width="30" height="30" viewBox="0 0 60 57" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {!isNaN(Number(data.price)) && (!collection.text) && (<div className="items-center flex ml-auto w-10 h-10 mr-3 mt-4 bg-[#304D68] rounded-full p-2"> 
